...
JAPANESE["CAMERA_PATCH_DESC"] =			"AdrenalineのPSPゲームにアナログスティックサポートを追加します"
...
JAPANESE["INSTALLP_DESC_NOAVLS"] =		"PS VitaのAVLS機能を無効化"
...
JAPANESE["INSTALLP_DESC_LOLICON"] =		"PS VitaのCPUクロックをオーバークロック有効化と、画面上にフレームレートを表示"
...
JAPANESE["INSTALLP_DESC_ADRENALINE"] =		"1回の操作でAdrenalineを作動させる"
...
JAPANESE["INSTALLP_DESC_IOPLUS"] = 		"ユーザランドでより多くのIO操作を可能にするPS Vitaカーネルプラグイン。元の機能を使用して、ユーザーアプリケーションとプラグインのIO許可を向上"
...
JAPANESE["INSTALLP_DESC_NOLED"] =		"PS Vitaのホームボタンを無効にする為のプラグイン"
...
--Boot_config.txt
JAPANESE["INSTALLP_DESC_CUSTOMBOOTSPLASH"] =	"起動時にPS Vita / PS TVにBoot Splashを表示 (Ensoが必要)"
...
JAPANESE["INSTALLP_DESC_NOLOCKSCREEN"] =	"PS Vitaのロック画面を無効化"
...
--ALL
JAPANESE["INSTALLP_DESC_VSHMENU"] =		"PS VitaゲームとHomebrewsのVSHメニューを表示するtaiHEN向けプラグイン"
...
JAPANESE["INSTALLP_DESC_VGI"] =			"PS Vitaゲームに関する有益な情報を表示するtaiHEN向けのプラグイン"
...
JAPANESE["INSTALLP_DESC_RESCALER"] =		"PS Vita用の独自のリスケーラを新規の物に置き換え、非ネイティブ解像度で動作するゲームがシェーダによるフィルタリングを使用し画質を改善"
...
JAPANESE["INSTALLP_DESC_REMAPSV"] =		"PS Vitaの全てのボタンを再配置や、前面タッチスクリーンと背面タッチパッドに追加ボタンを配置が出来るプラグイン"
