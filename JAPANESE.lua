...
JAPANESE["STRING_BACKUP_CONFIGS"] =		"Config_backups.txtを作成中"
...
JAPANESE["INSTALLP_WARNING_REFOOD"] =		"ur0:/taiに導入されてreFOODプラグインが正常に動作する様になりました"
...
JAPANESE["INSTALLP_DESC_REPATCH"] =		"ux0:patchの暗号化されたゲームの改造を可能にし、パッチ適用を可能にして、FW要求を回避します"
...
JAPANESE["INSTALLP_DESC_ADRENALINE"] =		"1回の操作ででAdrenalineを作動させる事が出来ます"
